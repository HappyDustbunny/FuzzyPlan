...
function Task(parsedText, id) {
  ...
  this.displayText = function () {  // Generates text to be displayed on tasks // TODO: Move to renderTasks
    let extraH = 0;
    let endH = 0;
    let endM = 0;
...
function addTask(here) {  // Create and add new task. Services the functions clickedTop and clickedBottom and Enter
